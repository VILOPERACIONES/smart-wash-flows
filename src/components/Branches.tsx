  ...
  const renderCard = (sucursal: Sucursal) => (
    ...
    >
      ...
      <div className="relative px-4 sm:px-8 pt-16 sm:pt-16">
        <img src={sucursal.imagen} className="w-full h-[188px] object-cover bg-[#C4C4C4] rounded-lg" />
      ...
      <div className="p-[33px] flex flex-col flex-1">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-start gap-3 mb-3">
            ...
            <span className="text-[#003A9E] font-poppins text-sm leading-5">{sucursal.direccion}</span>
          </div>

          {/* Horario solo si está activa */}
          {sucursal.estado === "activa" && (
            <div className="flex items-start gap-3 mb-8">
              ...
              <span className="text-[#003A9E] text-sm font-poppins leading-5">{sucursal.horario}</span>
            </div>
          )}
        </div>
        ...
        {sucursal.estado === "activa" ? (
          ...
          >
            <span className="text-white text-sm font-poppins font-semibold">Ver en Google Maps</span>
          </a>
        ) : (
          <button
            className="flex justify-center items-center opacity-50 shadow-[0_4px_14px_-3px_rgba(0,0,255,0.40)] bg-[#F3F5F7] py-3 rounded-xl w-full"
            disabled
          >
            <span className="text-[#003A9E] font-poppins text-sm font-semibold">Próximamente</span>
          </button>
        )}
      </div>
    </article>
