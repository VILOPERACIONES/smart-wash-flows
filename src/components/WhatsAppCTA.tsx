  ...
  return (
    <section className="w-full px-4 py-16">
      <div className="mx-auto max-w-4xl">
        <div className="relative overflow-hidden rounded-2xl px-6 py-20 text-center text-white shadow-xl md:px-12" style={{ background: 'linear-gradient(90deg, #0019FF 0%, #0033CC 50%, #00008B 100%)' }}>
          {/* Title */}
          ...
          <p className="mx-auto mt-4 max-w-xl font-poppins text-sm text-blue-100 md:text-base">
            Escríbenos ahora y resolvemos tus dudas al instante. Sin formularios
            largos, sin esperas.
          </p>
          ...
          {/* Footer note */}
          <p className="mt-4 text-xs font-poppins text-blue-200">
            Respuesta promedio: menos de 3 minutos
          </p>
        </div>
      </div>
    </section>
