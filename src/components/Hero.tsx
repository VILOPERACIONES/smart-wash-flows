    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Main headline */}
          <h1 className="animate-fade-up animation-delay-100 text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight mb-6">
            Lavar tu ropa
            <br />
          ...
          <div className="animate-fade-up animation-delay-400 mt-16 flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="text-sm font-semibold">$30/kg</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="text-sm font-semibold">Mismo día</p>
