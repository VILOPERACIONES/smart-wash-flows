      ...
      <div className="max-w-[1400px] mx-auto my-0">
        ...
        <div className="text-center mt-[60px]">
          <button
            ...
            className="btn-pulse inline-flex justify-center items-center shadow-[0_4px_14px_0_rgba(0,0,255,0.40)] gap-[13px] bg-[#00F] pt-[11px] pb-3 px-[34px] rounded-xl hover:bg-blue-700 transition-colors"
          >
